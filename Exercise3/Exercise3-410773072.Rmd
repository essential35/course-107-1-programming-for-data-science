...
```{r ans11}
stringr::str_replace_all(classData$`公-10-06`,"1","有看公告")->classData$`公-10-06`
stringr::str_replace_all(classData$`公-10-06`,"0","沒看公告")->classData$`公-10-06`
```
...
```{r ans21}
lubridate::mdy_hms(hwData$Timestamp)->time
lubridate::with_tz(time,tz = "Asia/Taipei")->hwData$Timestamp
```
...
```{r ans23}
difftime(deadline,hwData$Timestamp,units = c("days"))->hwData$early
```
